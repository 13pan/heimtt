<template>
  <div class="article-container">
        ...
        <div class="article-detail markdown-body" v-if="!!article.art_id">
          ...
          <van-cell class="user-info" center :border="false">
            ...
            <!-- <van-button
              ...
              >关注</van-button
            > -->
            <!-- <FallowUser :value="article.is_followed"
            @input="article.is_followed = $event"></FallowUser> -->
            <FallowUser
    ...
    <van-popup v-model="isReplayShow" position="bottom" style="height: 100%"
      ><ReplayComment :comment="comment" @close="isReplayShow=false"
      v-if="isReplayShow"></ReplayComment>
    </van-popup>
  </div>
</template>

<script>
import ReplayComment from '@/views/Article/components/ReplayComment.vue'
